...
public final class Mathf {
	...
	static public final float radiansTo2Degrees = 360f / (PI * 2);
	static public final float rad2Deg = radiansTo2Degrees;
	...
	static public float dif(float n1, float n2) {
		// n1 = y n2 = currentrotation
		return (n1 == 0 ? n2 : (n2 - n1)); 
		
	}
	static public ThreadLocalRandom random = ThreadLocalRandom.current();
